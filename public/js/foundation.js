!function (t) {
    ...
    var a = i(0), r = i.n(a), l = i(1), u = {
        ...
        keys: o(u), parseKey: s, handleKey: function (t, e, n) {
            ...
            if (s = "undefined" == typeof u.ltr ? u : i.i(l.b)() ? r.a.extend({}, u.ltr, u.rtl) : r.a.extend({}, u.rtl, u.ltr), o = s[h], a = n[o], a && "function" == typeof a) {
                var d = a.apply();
    ...
    function a(t, e, n, s, o, a) {
        switch (console.log("NOTE: GetOffsets is deprecated in favor of GetExplicitOffsets and will be removed in 6.5"), n) {
            case"top":
                return i.i(l.b)() ? r(t, e, "top", "left", s, o, a) : r(t, e, "top", "right", s, o, a);
            case"bottom":
                return i.i(l.b)() ? r(t, e, "bottom", "left", s, o, a) : r(t, e, "bottom", "right", s, o, a);
            case"center top":
            ...
            default:
                return {
                    left: i.i(l.b)() ? $anchorDims.offset.left - $eleDims.width + $anchorDims.width - o : $anchorDims.offset.left + o,
    ...
    var a = i(0), r = i.n(a), l = i(4), u = i(9), c = i(1), h = i(7), d = i(2), f = function () {
        ...
        return o(e, t), f(e, [{
            ...
            key: "_hideAll", value: function () {
                ...
                this.options.autoHeight && this.$wrapper.css({height: t.parent().closest("ul").data("calcHeight")}), t.one(i.i(c.c)(t), function (e) {
    ...
    var a = i(0), r = i.n(a), l = i(4), u = i(9), c = i(7), h = i(1), d = i(2), f = function () {
        ...
        return o(e, t), f(e, [{
            ...
            key: "_init", value: function () {
                ...
                this.$element.children(".is-dropdown-submenu-parent").children(".is-dropdown-submenu").addClass("first-sub"), this.$menuItems = this.$element.find('[role="menuitem"]'), this.$tabs = this.$element.children('[role="menuitem"]'), this.$tabs.find("ul.is-dropdown-submenu").addClass(this.options.verticalClass), "auto" === this.options.alignment ? this.$element.hasClass(this.options.rightClass) || i.i(h.b)() || this.$element.parents(".top-bar-right").is("*") ? (this.options.alignment = "right", t.addClass("opens-left")) : (this.options.alignment = "left", t.addClass("opens-right")) : "right" === this.options.alignment ? t.addClass("opens-left") : t.addClass("opens-right"), this.changed = !1, this._events()
            }
        }, {
            ...
            key: "_isRtl", value: function () {
                return this.$element.hasClass("align-right") || i.i(h.b)() && !this.$element.hasClass("align-left")
            }
        }, {
            key: "_events", value: function () {
    ...
    var a = i(0), r = i.n(a), l = i(4), u = i(1), c = i(15), h = i(5), d = function () {
        function t(t, e) {
            for (var i = 0; i < e.length; i++) {
                var n = e[i];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
    ...
    var a = i(0), r = i.n(a), l = i(1), u = i(2), c = i(33), h = function () {
        function t(t, e) {
            for (var i = 0; i < e.length; i++) {
                var n = e[i];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
    ...
    var a = i(0), r = i.n(a), l = i(4), u = i(3), c = i(1), h = i(2), d = i(5), f = function () {
        ...
        return o(e, t), f(e, [{
            ...
            key: "close", value: function (t) {
                if (this.$element.hasClass("is-open") && !this.isRevealed) {
                    var e = this;
                    this.$element.removeClass("is-open"), this.$element.attr("aria-hidden", "true").trigger("closed.zf.offcanvas"), this.$content.removeClass("is-open-left is-open-top is-open-right is-open-bottom"), this.options.contentScroll === !1 && (r()("body").removeClass("is-off-canvas-open").off("touchmove", this._stopScrolling), this.$element.off("touchstart", this._recordScrollable), this.$element.off("touchmove", this._stopScrollPropagation)), this.options.contentOverlay === !0 && this.$overlay.removeClass("is-visible"), this.options.closeOnClick === !0 && this.options.contentOverlay === !0 && this.$overlay.removeClass("is-closable"), this.$triggers.attr("aria-expanded", "false"), this.options.trapFocus === !0 && (this.$content.removeAttr("tabindex"), l.a.releaseFocus(this.$element)), this.$element.one(i.i(c.c)(this.$element), function (t) {
    ...
    var a = i(0), r = i.n(a), l = i(4), u = i(6), c = i(34), h = i(8), d = i(1), f = i(2), p = i(16), m = function () {
        function t(t, e) {
            for (var i = 0; i < e.length; i++) {
                var n = e[i];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
    ...
    var a = i(0), r = i.n(a), l = i(3), u = i(1), c = i(2), h = i(10), d = i(14), f = function () {
            function t(t, e) {
                for (var i = 0; i < e.length; i++) {
                    var n = e[i];
                    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
    ...
    var u = i(0), c = i.n(u), h = i(4), d = i(6), f = i(1), p = i(2), m = i(16), g = i(5), v = function () {
        function t(t, e) {
            for (var i = 0; i < e.length; i++) {
                var n = e[i];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
        ...
        return o(e, t), v(e, [{
            ...
            key: "_handleEvent", value: function (t, e, n) {
                ...
                if (n) s = this._adjustValue(null, n), o = !0; else {
                    ...
                    b = y < 0 ? 0 : y > m ? m : y;
                    var w = a(b, m);
                    if (s = this._value(w), i.i(f.b)() && !this.options.vertical && (s = this.options.end - s), s = l._adjustValue(null, s), o = !1, !e) {
    ...
    var a = i(0), r = i.n(a), l = i(1), u = i(3), c = i(5), h = i(15), d = function () {
        function t(t, e) {
            for (var i = 0; i < e.length; i++) {
                var n = e[i];
                n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(t, n.key, n)
